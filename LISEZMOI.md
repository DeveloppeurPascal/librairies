...
Les unités à utiliser dans vos projets se trouvent dans le dossier "src". Certaines fonctionnalités sont [expliquées sur mon blog](https://developpeur-pascal.fr/librairies-publiques.html) ou [ont été codées en live sur Twitch](https://serialstreameur.fr/librairies-et-composants.html).
...
D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://librairies.developpeur-pascal.fr) ou [le devlog du projet](https://developpeur-pascal.fr/librairies-publiques.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/librairies/issues) pour que je teste et tente de corriger ou fournir un contournement.
