unit USVGSampleImages;

// SVG from folder "C:\Users\patrickpremartin\Documents\Embarcadero\Studio\Projets\librairies\samples\Skia.SVGToBitmap\SampleImages"
// Generated by https://github.com/DeveloppeurPascal/one-shot-tools/SVGFromFolderToStringArrayInUnit
// Last updated : 20/05/2024 14:59:10
...
ArrowSw=CSVGArrowSw,
ArrowW=CSVGArrowW);
var SVGSampleImages : array of string;
implementation
initialization
setlength(SVGSampleImages,8);
SVGSampleImages[CSVGArrowE] := '''
